...
<template>
  ...
  <div>
    ...
    <div class="button-container">
      ...
      <!--<div v-if="inputPhone==false" class="button-unclick" @click="clickTypePost">-->
        <!--<text class="title" style="height: 80px ;padding: 20px;color: #FFFFFF">下一步</text>-->
      <!--</div>-->
    </div>
    ...
    <!--<div class="button-container">-->
      <!--<div class="button" @click="clickTypePost">-->
        <!--<div class="title" style="height: 80px ;padding: 20px;color: #FFFFFF">-->
            <!--<text v-if="flag==true" style="color: #FFFFFF"> 下一步</text>-->
            <!--<text v-if="flag==false" style="color: #FFFFFF"> 下一步2</text>-->
        <!--</div>-->
      <!--</div>-->
    <!--</div>-->
