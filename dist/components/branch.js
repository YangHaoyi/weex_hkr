...
__vue_options__.__file = "/Users/yanghaiyi/Documents/weex/hkr/awesome-project/src/components/branch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-96b74ebe"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        //登录
        loadCar: function loadCar(event) {
            this.interval = 1000;
            var me = this;
            me.isShow = true;
            stream.fetch({
                ...
                url: 'https://hkr.evershare.cn:17777/hkr-agg-he/api/v1/vehicles?rentalshop_id=6518035492800492868&vehicle_status=8',
                type: 'json'
            }, function (ret) {
                if (!ret.ok) {
        ...
        bookCar: function bookCar(event) {
            this.interval = 1000;
            var me = this;
            me.isShow = true;
            ...
            stream.fetch({
                ...
                headers: { 'Content-Type': 'application/json',
                    'token': me.token,
                    'x-auth-token': me.authToken },
                url: 'https://hkr.evershare.cn:17777/hkr-agg-he/api/v1/rentals',
                type: 'json',
                body: JSON.stringify({
                    phoneNo: me.phoneNo,
                    source: '2',
        ...
        toOrder: function toOrder(event) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('list', {
  ...
  }, _vm._l((_vm.carList), function(num) {
    return _c('cell', {
      staticClass: ["cell"],
      appendAsTree: true,
      attrs: {
    ...
    }, [_vm._v(_vm._s(num.vno))])])]), _c('div', {
      staticClass: ["car-info"]
    }, [_c('div', [_vm._v(_vm._s(num.vehicleMode.vehicleModelName))]), _c('div', [_vm._v(_vm._s(num.vehicleMode.vehicleModelStr))])]), _c('image', {
      staticClass: ["car"],
      attrs: {
        "src": num.vehicleMode.pictureUrl
      }
    })]), _c('div', {
