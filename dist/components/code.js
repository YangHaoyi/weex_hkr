...
__vue_options__.__file = "/Users/yanghaiyi/Documents/weex/hkr/awesome-project/src/components/code.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b7501da8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        //            跳转网点
        toBranch: function toBranch(event) {
        ...
        login: function login(event) {
            ...
            stream.fetch({
                ...
                url: 'https://hkr.evershare.cn:17777/hkr-na/api/v1/login/dynamic_token',
                type: 'json',
                body: JSON.stringify({
                    phoneNo: me.phoneNo,
                ...
                if (!ret.ok) {
                    ...
                    storage.setItem('phoneNo', me.phoneNo, function (event) {
                        console.log('success');
                    });
                    storage.setItem('login', "login", function (event) {
                        console.log('success');
                    });
                    storage.setItem('authToken', ret.data.payload.authToken, function (event) {
                        console.log('success' + ret.data.payload.authToken);
                    });
                    storage.setItem('token', ret.data.payload.token, function (event) {
        ...
        //保存token
        saveToken: function saveToken(event) {
            storage.setItem('phoneNo', this.phoneNo, function (event) {
                console.log('success');
            });
            storage.setItem('login', "login", function (event) {
                console.log('success');
            });
            storage.setItem('authToken', event.data.payload.authToken, function (event) {
                console.log('success');
            });
            storage.setItem('token', event.data.payload.token, function (event) {
                console.log('success');
            });
        }
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.phoneNo))])]), _c('div', {
