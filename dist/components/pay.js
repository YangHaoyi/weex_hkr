...
__vue_options__.__file = "/Users/yanghaiyi/Documents/weex/hkr/awesome-project/src/components/pay.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-921f018e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
    ...
    methods: {
        balancePay: function balancePay() {
            ...
            stream.fetch({
                ...
                url: "https://hkr.evershare.cn:17777/hkr-agg-si/api/v1/pay/unified_order/orderId=" + me.orderId + "/type=8/orderType=1?hkcoin=0",
                type: 'json'
            }, function (ret) {
                if (!ret.ok) {
