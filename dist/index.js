...
__vue_options__.__file = "/Users/yanghaiyi/Documents/weex/hkr/awesome-project/src/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-41f8e438"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports = {
    ...
    methods: {
        ...
        clickTypePost: function clickTypePost() {
            this.interval = 1000;
            var me = this;
            me.isShow = true;
            stream.fetch({
                ...
                url: 'https://hkr.evershare.cn:17777/hkr-agg-ar/api/v1/verify_codes',
                type: 'json',
        ...
        toCode: function toCode(event) {

            storage.setItem('phoneNo', this.txtInput, function (event) {
                console.log('success');
            });

            navigator.push({
                url: 'http://192.168.100.104:8085/dist/components/code.js',
                animated: "true"
            }, function (event) {
        ...
        oninput: function oninput(event) {
            ...
            console.log('oninput', event.value.length);
        },
